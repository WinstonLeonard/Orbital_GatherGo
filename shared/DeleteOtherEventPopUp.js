    ...
    return (
        <Modal visible={modalVisible} onRequestClose={closeModal} transparent = {true} animationType='fade'>
            ...
            <View style = {styles.textContainer}>
              <Text style = {styles.textBody}>Do you really want to delete this event? You won't be able to join this event until you have been re-invited again.
              This is process cannot be undone.</Text>
            </View>
